 ...
 *
 *  For an inward pinch the start point is at a 20% margin of the view's bounding rect
        on either side and stops at the center.
 *  The default angle of the pinch action is 30 degrees to closely
