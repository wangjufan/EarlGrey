...
+ (UIImage *)takeScreenshotForAppStore {
  ...
  unsigned char *imageBuffer = grey_createImagePixelDataFromCGImageRef(screenshot.CGImage,&bitmapContext);
...
+ (UIImage *)snapshotElement:(id)element {
  ...
  CGPoint translationPoint = CGPointMake(
                    -(elementAXFrame.origin.x - (viewAXFrame.origin.x)),
