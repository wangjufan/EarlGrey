...
/**
 *  @return An image of the current app's screen frame buffer.
 *         This method waits for any pending screen updates to go through before taking a screenshot.
 *         Returned image orientation is same as the current interface orientation.
 */
 ...
 *          @c element must be an instance of @c UIView or an accessibility element.
 */
