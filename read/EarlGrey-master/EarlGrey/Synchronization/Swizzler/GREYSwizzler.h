 ...
 *  implementation will be saved.
 *  If @c klass does not directly implement @c methodSelector1 (inherits it from a superclass),
 *  we dynamically override @c methodSelector1 with a copy of @c methodSelector2's implementation.
 *  This is to avoid swizzling the superclass's implementation.
 *  The same happens for @c methodSelector2, if @c klass does not directly
...
/**
 *  Adds @c methodSelector with implementation @c imp to @c klass.
 *  After that, swizzles @c methodSelector with @c sel.
 *  @c sel must be an instance method of @c klass and
...
/**
 *  Invokes the original implementation from inside a swizzled implementation.
 *   Use this instead of INVOKE_ORIGINAL_IMP when the original selector takes one argument.
 *
 *  @param __returnType  The return type of the original implementation.
 *  @param __swizzledSEL The selector used for swizzling.
...
/**
 *  Invokes the original implementation from inside a swizzled implementation.
 *  Use this instead of INVOKE_ORIGINAL_IMP when the original selector takes two arguments.
 *
 *  @param __returnType  The return type of the original implementation.
 *  @param __swizzledSEL The selector used for swizzling.
 *  @param __arg1        The first argument to be passed to the original implementation.
...
/**
 *  Invokes the original implementation from inside a swizzled implementation.
 *  Use this instead of INVOKE_ORIGINAL_IMP when the original selector takes three arguments.
 *
 *  @param __returnType  The return type of the original implementation.
 *  @param __swizzledSEL The selector used for swizzling.
 *  @param __arg1        The first argument to be passed to the original implementation.
...
/**
 *  Invokes the original implementation from inside a swizzled implementation.
 *  Use this instead of INVOKE_ORIGINAL_IMP when the original selector takes four arguments.
 *
 *  @param __returnType  The return type of the original implementation.
 *  @param __swizzledSEL The selector used for swizzling.
 *  @param __arg1        The first argument to be passed to the original implementation.
...
/**
 *  Invokes the original implementation from inside a swizzled implementation.
 *   Use this instead of INVOKE_ORIGINAL_IMP when the original selector takes five arguments.
 *
 *  @param __returnType  The return type of the original implementation.
 *  @param __swizzledSEL The selector used for swizzling.
 *  @param __arg1        The first argument to be passed to the original implementation.
