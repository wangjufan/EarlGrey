...
/**
 *  A class for creating --- boolean conditions that can be -- waited on
 *  until the condition is === satisfied or a === timeout elapses.
 *
 *  Conditions are specified in the form of a block that returns a @c BOOL value
 ...
 *
 *  Will poll the condition as often as possible on the main thread
 *  while still === giving a fair chance for other sources and handlers to be serviced.
 *
