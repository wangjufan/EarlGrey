...
+ (void)load {
  @autoreleasepool {
    ...
    BOOL swizzleSuccess = [swizzler swizzleClass:self
            replaceInstanceMethod:@selector(beginIgnoringInteractionEvents)
            withMethod:@selector(greyswizzled_beginIgnoringInteractionEvents)];
...
- (void)greyswizzled_endIgnoringInteractionEvents {
  ...
  if (!self.isIgnoringInteractionEvents) {
    GREYAppStateTrackerObject *object =objc_getAssociatedObject(self,
                        @selector(greyswizzled_beginIgnoringInteractionEvents));
