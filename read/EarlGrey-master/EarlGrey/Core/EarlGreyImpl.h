...
/**
 *  Dismisses the keyboard by resigning the first responder, if any.
 *  Will populate the provided error
 *             if the first responder is not present
 *             or if the keyboard is not visible.
 *  @param[out] errorOrNil Error that will be populated on failure. If @c nil, a test
