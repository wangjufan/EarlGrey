...
/** Interaction with UI elemetns is the core of earlgrey .
...
/**
 *  Indicates that the current interaction
 *   should be performed on a UI element
 *      contained inside another UI element
 *          that is uniquely matched by @c rootMatcher.
 *
 *  @param rootMatcher Matcher used to select the container of the element
 *                     the interaction will be performed on.
 *
 ...
 *  Please make sure that this is used after you've created the matcher.
 *  For example, in case three elements are matched, and you wish to match with the second one,
 *  then @c atIndex would be used in this manner:
 *
 *  @code
