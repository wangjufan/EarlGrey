...
//////////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////////
//used by GREYProvider and GREYElementHierarchy
/**
 *  A private wrapper used to store information
 *  that is essential for printing the UI hierarchy
 ...
 *  @return Creates a new array that contains the immediate children of @c element.
 *         The children are ordered from front to back,
 *          meaning subviews that were added first are present later in the array. 
 *         If no children exist, then an empty array is returned.
 */
