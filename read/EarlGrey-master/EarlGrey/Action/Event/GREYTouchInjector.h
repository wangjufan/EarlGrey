...
/** 单指的一个完整的触摸序列， use once and discard
...
/**
 *  Enqueues @c touchInfo that will be
 *           materialized into a UITouch and delivered to application.
 * *  @param touchInfo The info that is used to create the UITouch.
 *                   If it represents a last touch in a sequence,
 *                   the specified @c point value is ignored
 *                   and injector automatically picks the previous point
 *                   where touch occured to deliver the last touch.
 */
