 ...
 */
@property(nonatomic, readonly) NSArray *points;// the data should remain clean and align in size
/**
...
/**
 *  Indicates that this touch can be dropped
 *  if system delivering the touches experiences a lag
