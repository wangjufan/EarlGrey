...
/**
 *  Utility to deliver user actions
 *  such as touches, taps, gestures and device rotation
 *  to the application under test
 */
@interface GREYSyntheticEvents : NSObject
/**
 *  Rotate the device to a given @c deviceOrientation.
 *  All device orientations except for @c UIDeviceOrientationUnknown are supported.
 *  If a non-nil @c errorOrNil is provided,
 *     it will be populated with the failure reason if the orientation change fails,
 *     otherwise a test failure will be registered.
 *
 ...
 *             If @c errorOrNil is @c nil and the operation fails, it will throw an exception.
 */
