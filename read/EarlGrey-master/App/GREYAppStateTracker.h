 ...
 *              including the provided @c state
 *              and updating the overall state of the application.
 *  If @c object is already being tracked with for a different state, the object's state will be updated to a XOR of the current state and @c state.
 ...
 */
- (GREYAppStateTrackerObject * _Nullable)trackState:(GREYAppState)state
                                       forObject:(id)object;
/**
 *  Untracks the state for the object with the specified id.
 *   For untracking, it does not matter if the state has been added to being ignored.
 ...
 *                untracked.
 */
- (void)untrackState:(GREYAppState)state
           forObject:(GREYAppStateTrackerObject *)object;
