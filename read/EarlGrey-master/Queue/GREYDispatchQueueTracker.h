 ...
 *  At most one tracker exists for each dispatch queue.
 *  The tracker will continue tracking the dispatch queue
 *  until the tracker or the tracker's underlying queue has been deallocated.
 */
